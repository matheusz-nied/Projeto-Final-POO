...
public class Academia {
	...
	public static void main(String[] args) {
		...
		Professor pf2 = new Professor("Aroldo", "Marrom", 4, 50.0);
		pf2.setQuantidadeAulas(1);
		Professor pf3 = new Professor("Gabriel", "Preta", 4, 100.0);
		pf3.setQuantidadeAulas(2);
		pf3.aumentaQuantidadeGraus();
		Aluno a1 = new Aluno("Matheus", "Roxa", 3);
		a1.aumentaQuantidadeGraus();
		Aluno a2 = new Aluno("Rodrigo", "Roxa", 4);
